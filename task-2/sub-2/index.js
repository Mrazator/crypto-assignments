...
// 196 bits
const message1part1 = ''
const message2part1 = ''
...
Object.keys(inputs).map(x => {
    ...
    while(true) {
        const buf = new Buffer(crypto.randomBytes(196), 'hex')
        hash.update(buf)
        hash.reset()
    }
})
